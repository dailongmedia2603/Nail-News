  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-6">
        ...
        <Card className="cursor-pointer hover:bg-muted" onClick={() => navigate('/admin/transactions')}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2"><CardTitle className="text-sm font-medium">Quản lý Giao dịch</CardTitle><Receipt className="h-4 w-4 text-muted-foreground" /></CardHeader>
            <CardContent><p className="text-xs text-muted-foreground">Xem và quản lý lịch sử giao dịch.</p></CardContent>
        </Card>
