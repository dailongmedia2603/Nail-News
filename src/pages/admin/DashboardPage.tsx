    ...
    <div className="container mx-auto p-4 md:p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-6">
        <Card className="cursor-pointer hover:bg-muted" onClick={() => navigate('/admin/posts')}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2"><CardTitle className="text-sm font-medium">Quản lý Tin đăng</CardTitle><List className="h-4 w-4 text-muted-foreground" /></CardHeader>
        ...
        <Card className="cursor-pointer hover:bg-muted" onClick={() => navigate('/admin/blog')}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2"><CardTitle className="text-sm font-medium">Quản lý Blog</CardTitle><Newspaper className="h-4 w-4 text-muted-foreground" /></CardHeader>
        ...
        <Card className="cursor-pointer hover:bg-muted" onClick={() => navigate('/admin/categories')}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2"><CardTitle className="text-sm font-medium">Quản lý Danh mục</CardTitle><FolderKanban className="h-4 w-4 text-muted-foreground" /></CardHeader>
        ...
        <Card className="cursor-pointer hover:bg-muted" onClick={() => navigate('/admin/tags')}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2"><CardTitle className="text-sm font-medium">Quản lý Tag</CardTitle><Tags className="h-4 w-4 text-muted-foreground" /></CardHeader>
            <CardContent><p className="text-xs text-muted-foreground">Quản lý tag và từ khóa</p></CardContent>
        </Card>
        <Card className="cursor-pointer hover:bg-muted" onClick={() => navigate('/admin/settings')}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2"><CardTitle className="text-sm font-medium">Cấu hình Hệ thống</CardTitle><Settings className="h-4 w-4 text-muted-foreground" /></CardHeader>
            <CardContent><p className="text-xs text-muted-foreground">Tùy chỉnh logo, tên website và các thông tin khác</p></CardContent>
        </Card>
      </div>
      <Card>
